 ...
 */
class CustomRenderer extends \Magento\Framework\View\Element\Template implements
    \Magento\Framework\DataObject\IdentityInterface
{
    ...
    public function __construct(
        ...
        \Lenawesome\MyModule\Helper\Data $cdata
    ) {
        $this->_myData = $cdata;
     ...
     * @codeCoverageIgnore
     */
    public function isChildConfigEnable(){
        return $this->_myData->getGeneralConfig('enable')==1;
    }
